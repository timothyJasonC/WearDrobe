...
export async function listProductCategory() {
    return [
        { id: '01f5a819-4e7e-4bf3-9997-199f4c97bc4e', gender: ProductGender.UNISEX, type: ProductTypes.ACCESSORIES, category: 'Sunglasses' },
        { id: '058ef1a4-7c7e-40fb-90e8-4bbed7e3df18', gender: ProductGender.WOMEN, type: ProductTypes.BOTTOMS, category: 'Jeans' },
        { id: '09e3fac9-7d79-44ad-82ac-a502fc94eb35', gender: ProductGender.WOMEN, type: ProductTypes.ACCESSORIES, category: 'Sunglasses' },
        { id: '19c40075-9adb-46be-8e02-e27b062e7955', gender: ProductGender.WOMEN, type: ProductTypes.BOTTOMS, category: 'Casual Pants' },
        { id: '28d0a0f2-7663-4b51-958c-0fbcffda298a', gender: ProductGender.MEN, type: ProductTypes.BOTTOMS, category: 'Shorts' },
        { id: '2ad43c7a-450e-43d6-900d-6544d5a71010', gender: ProductGender.WOMEN, type: ProductTypes.TOPS, category: 'Coats' },
        { id: '4777d5ad-f3de-44c2-8683-e197d5b57154', gender: ProductGender.WOMEN, type: ProductTypes.TOPS, category: 'T-Shirts' },
        { id: '4bc7b121-73d5-4743-b1b2-7f77992c0c4e', gender: ProductGender.MEN, type: ProductTypes.TOPS, category: 'Coats' },
        { id: '595842bd-69c1-45e0-8f59-02fb060c077b', gender: ProductGender.WOMEN, type: ProductTypes.ACCESSORIES, category: 'Bags' },
        { id: '5ab58c18-bc32-4d4c-a948-1f050b35799f', gender: ProductGender.MEN, type: ProductTypes.ACCESSORIES, category: 'Bags' },
        { id: '6026774b-10c9-4e93-ba89-eb9628a189cc', gender: ProductGender.WOMEN, type: ProductTypes.BOTTOMS, category: 'Trousers' },
        { id: '65e34a4f-af03-44e8-aa91-ca53eeec7765', gender: ProductGender.WOMEN, type: ProductTypes.TOPS, category: 'Dresses' },
        { id: '7175afc8-0d54-486e-86ac-20118eff8ccc', gender: ProductGender.MEN, type: ProductTypes.TOPS, category: 'Jackets' },
        { id: '71c2825a-62c2-4b5a-9c8a-8b21f0e42b4c', gender: ProductGender.MEN, type: ProductTypes.BOTTOMS, category: 'Trousers' },
        { id: '74b30259-d53d-443f-ac3a-25100988c188', gender: ProductGender.WOMEN, type: ProductTypes.TOPS, category: 'Blazers' },
        { id: '76e5acf6-6f29-457a-a96d-a6733db2eaeb', gender: ProductGender.WOMEN, type: ProductTypes.BOTTOMS, category: 'Skirts' },
        { id: '77d3b913-233b-4f1f-842c-fb89abb676fb', gender: ProductGender.MEN, type: ProductTypes.TOPS, category: 'Formal Shirts' },
        { id: '926dd8c4-ea89-43dd-8898-f6bcae201816', gender: ProductGender.WOMEN, type: ProductTypes.ACCESSORIES, category: 'Hats' },
        { id: '955c46fc-11c2-4839-aa26-d71d23ce570a', gender: ProductGender.MEN, type: ProductTypes.BOTTOMS, category: 'Casual Pants' },
        { id: '9be5f6c9-5583-4304-b2d1-cda66c24841a', gender: ProductGender.MEN, type: ProductTypes.TOPS, category: 'T-Shirts' },
        { id: '9e93bfed-1490-4564-bdc5-dc1caa118809', gender: ProductGender.WOMEN, type: ProductTypes.ACCESSORIES, category: 'Belts' },
        { id: 'a012418f-1cfd-4043-b792-6256c1dc830f', gender: ProductGender.MEN, type: ProductTypes.ACCESSORIES, category: 'Belts' },
        { id: 'a8eda2b1-cabf-4584-875a-e8486cee0f91', gender: ProductGender.MEN, type: ProductTypes.TOPS, category: 'Casual Shirts' },
        { id: 'a9f07f97-ffe0-4b6e-8342-99305fcc1f3b', gender: ProductGender.MEN, type: ProductTypes.BOTTOMS, category: 'Sweat Pants' },
        { id: 'ac2ad9ad-fcb4-4cab-8c82-f7324f67c24d', gender: ProductGender.MEN, type: ProductTypes.TOPS, category: 'Polo Shirts' },
        { id: 'ad926dfe-dec7-443f-934a-5ed322905140', gender: ProductGender.WOMEN, type: ProductTypes.BOTTOMS, category: 'Sweat Pants' },
        { id: 'ad979506-cefb-4190-90fa-a1ce53f50d38', gender: ProductGender.WOMEN, type: ProductTypes.TOPS, category: 'Sweaters' },
        { id: 'b0a517da-9398-49ec-a41f-bfb7d1c919d0', gender: ProductGender.MEN, type: ProductTypes.ACCESSORIES, category: 'Hats' },
        { id: 'b627820b-6249-4d34-b34b-80e2f3e14354', gender: ProductGender.WOMEN, type: ProductTypes.BOTTOMS, category: 'Shorts' },
        { id: 'bc2d9ab4-88db-4c56-afd1-7ec3d6d6eeaa', gender: ProductGender.UNISEX, type: ProductTypes.ACCESSORIES, category: 'Hats' },
        { id: 'c002a3f8-a52e-4dec-a712-e8b83813f99c', gender: ProductGender.MEN, type: ProductTypes.TOPS, category: 'Suits and Blazers' },
        { id: 'c128a4ef-a3d5-421b-acc0-59d73a608905', gender: ProductGender.UNISEX, type: ProductTypes.ACCESSORIES, category: 'Bags' },
        { id: 'cf53ed7e-24bb-41ab-ac5f-047f44bfb618', gender: ProductGender.MEN, type: ProductTypes.BOTTOMS, category: 'Chinos' },
        { id: 'd354f3eb-d72a-40ba-842e-fc824e0e776b', gender: ProductGender.WOMEN, type: ProductTypes.TOPS, category: 'Blouses' },
        { id: 'e3376331-d33e-4116-bb1e-7418a037520d', gender: ProductGender.MEN, type: ProductTypes.ACCESSORIES, category: 'Sunglasses' },
        { id: 'e9261565-6ee5-41c2-922b-9046f962b66e', gender: ProductGender.MEN, type: ProductTypes.BOTTOMS, category: 'Jeans' },
        { id: 'f4ad0030-68f2-44c9-a4f7-0278575e444c', gender: ProductGender.UNISEX, type: ProductTypes.TOPS, category: 'Collaborations' },
        { id: 'f98d9cf2-074c-4a60-8576-32967e6ef03f', gender: ProductGender.MEN, type: ProductTypes.TOPS, category: 'Sweaters' },
        { id: 'fc6a1c82-d278-4d86-8294-e4b3ec5721aa', gender: ProductGender.WOMEN, type: ProductTypes.BOTTOMS, category: 'Leggings  Pants' },
        { id: 'ff452fb3-c4ee-4e44-a7ac-b45633b111fa', gender: ProductGender.WOMEN, type: ProductTypes.TOPS, category: 'Casual Shirts' }
    ];
}
