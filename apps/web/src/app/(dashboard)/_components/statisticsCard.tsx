...
export const StatisticsCard = ({title, number, modalElement}:{title:string, number?:number | string, modalElement?: React.ReactNode}) => {
  ...
  return (
    <div className='bg-white/80 flex flex-col max-sm:items-center min-w-28 lg:min-w-72 flex-1 rounded-xl shadow-[0px_0px_6px_-2px_rgba(0,0,0,0.5)] max-sm:p-2 sm:py-5 sm:px-10'>
