...
export const columns: ColumnDef<IUser>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => (
          <div className="capitalize flex justify-center">{row.getValue(`accountActive`) ? 
              <ToolTip className='' content={`user is verified`} >
                  <div className="w-3 h-3 rounded-full bg-green-400"></div>
              </ToolTip>
              :
              <ToolTip className='' content={`user is NOT verified`} >
